...
namespace DataAccess.Migrations
{
    ...
    [Migration("20250504135631_Add paypal related stuff")]
    partial class Addpaypalrelatedstuff
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DataAccess.Models.ContractorPaymentInfo", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("ContractorPaymentInfos");
                });
            ...
            modelBuilder.Entity("DataAccess.Models.Contractor", b =>
                {
            ...
            modelBuilder.Entity("DataAccess.Models.Chat", b =>
                {
                    ...
                    b.HasOne("DataAccess.Models.Work", "Work")
                        .WithOne("Chat")
                        .HasForeignKey("DataAccess.Models.Chat", "WorkId")
            ...
            modelBuilder.Entity("DataAccess.Models.ContractorPaymentInfo", b =>
                {
                    b.HasOne("DataAccess.Models.Contractor", "Contractor")
                        .WithOne()
                        .HasForeignKey("DataAccess.Models.ContractorPaymentInfo", "ContractorId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("DataAccess.Models.Message", b =>
                {
                    b.HasOne("DataAccess.Models.Chat", "Chat")
                        .WithMany("Messages")
